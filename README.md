...
<pre>git clone https://github.com/Mr-killnet/Fake-Root.git</pre>
<pre>cd Fake-Root</pre>
...
<pre>apt-get update && apt upgrade-y && apt-get install git -y && git clone https://github.com/Mr-killnet/Fake-Root.git</pre>
...
# Copyright
<pre>© Copyright credits goes to Mr-killnet. This tool is public tool anyone can use this tool.</pre>
